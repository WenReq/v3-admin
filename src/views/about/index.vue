<template>
	<div>
		<div class="card mb10">
			...
			<span class="text">
				<el-link type="primary" href="https://github.com/WenReq/v3-admin" target="_blank">V3-Admin-Template</el-link>
		...
		<div class="card mb10">
			...
			<el-descriptions :column="2" border>
				...
				<el-descriptions-item label="Github" label-align="left">
					<el-link type="primary" href="https://github.com/WenReq/v3-admin" target="_blank"> Github </el-link>
				</el-descriptions-item>
			</el-descriptions>
		</div>
		<div class="card mb10">
